...
namespace SmartBus.Infrasturcture.Migrations
{
    ...
    [Migration("20260601110222_AddingInvoiceIdToRefundRequestTable")]
    partial class AddingInvoiceIdToRefundRequestTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartBus.Domain.Models.RefundRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SmartBus.Domain.Models.RefundRequest", b =>
                {
                    b.HasOne("SmartBus.Domain.Models.Booking", "Booking")
                        .WithOne()
                        .HasForeignKey("SmartBus.Domain.Models.RefundRequest", "BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
